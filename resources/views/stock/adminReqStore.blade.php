...
<div class="container-fluid text-dark ">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold  " style="font-size:20px; color:black;"><b>Add Stock</b>
            </h6>
        </div>
        <div class="card shadow mb-4">
            <div class=" card-body">
                ...
                <form class="blockquote">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="deliveryNumber"
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end mb-2">
                        <button type="submit" class="  btn-warning data-bs-toggle=" button" autocomplete="off" ">Stock in</button>
        </div>
    </div>    
