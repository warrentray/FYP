        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                ...
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">
                    ...
                    @elseif(isset($user['gender']) && $user['gender'] == 'Male')
                    <img class="img-profile rounded-circle" src="{{asset('admin/img/undraw_profile.svg')}}">
                    @else
                    <!-- Default image if gender is not specified or not recognized -->
                    <img class="img-profile rounded-circle" src="{{asset('admin/img/default_profile.svg')}}">
                    @endif
                    @elseif($customer)
                    {{ $customer['name'] }}
                    <!-- You can add similar logic for customer's gender here if needed -->
                    <img class="img-profile rounded-circle" src="{{asset('admin/img/default_profile.svg')}}">
                    @else
                    Guest
                    <!-- You can add default image for guest here if needed -->
                    <img class="img-profile rounded-circle" src="{{asset('admin/img/default_profile.svg')}}">
                    @endif
                </span>
            </a>
