    ...
    <div class="container-fluid text-dark">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold" style="font-size:20px; color:black;"><b>Apply leave</b></h6>
            </div>
            ...
            <div class="card-body">
                ...
                <form id="applyLeaveForm" class="blockquote" method="post" action="{{ route('applyLeave') }}"
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end mb-2">
                        <button type="submit" class="btn btn-warning" data-bs-toggle="button"
                            autocomplete="off">Apply</button>
                    </div>
                </form>
            </div>
        </div>
